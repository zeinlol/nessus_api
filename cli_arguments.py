...
def init_args():
    ...
    parser.add_argument('-t', '--target', type=str, required=True, help='address [url: http://donki.xyz/ or domain: donki.xyz]')
    parser.add_argument('-u', '--username', type=str, required=True, help='Nessus user name')
    parser.add_argument('-p', '--password', type=str, required=True, help='Nessus user password')
